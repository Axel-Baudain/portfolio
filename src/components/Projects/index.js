...
const scenariothequedesc = "Une bibliothèque communautaire de scénarios de jeux de rôles, destinée aux maîtres de jeux. [PAUSED]";

const pongtitle = "Pong Remastered"
const pongdesc = "Le célèbre jeu PONG revisité et mis en ligne. Jouable à deux en local ! [MVP DONE]";

const haircuttitle = "Betty B. Coiffure"
const haircutdesc = "Le site vitrine d'un salon de coiffure réalisé gratuitement au bénéfice de sa propriétaire [WORK IN PROGRESS]";
...
const Projects = () => (
  <div className="projects__page">
    ...
    <div className="all__projects">
      ...
      <SingleProject title={haircuttitle} emoji="✂️" desc={haircutdesc} image={haircutimage} link="https://bettybcoiffure-demo.surge.sh" available={true} />
